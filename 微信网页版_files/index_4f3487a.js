...
, function(e, exports) {
    !function() {
        ...
        function(e, t, a, n, i, o, r, c, s, l, d, f, u, m, g, p, h, M, v, y, b, C, w) {
            ...
            function G(e) {
                ...
                try {
                    ...
                    angular.forEach(e.AddMsgList, function(e, t) {
                        if (u.messageProcess(e),
                        e.FromUserName != f.getUserName()) {
                            f.setRMsgCount(f.getRMsgCount() + 1);
                            var t = P.indexOf(e.FromUserName);
                            t == -1 && (f.setRConvCount(f.getRConvCount() + 1),
            ...
            t.isIPad = h.isIPad,
            t.isMacOS = h.isMacOS,
            t.isWindows = h.isWindows,
            t.showDownloadEntry = t.isMacOS || t.isWindows,
            t.closeDownloadEntry = function() {
                t.showDownloadEntry = !1,
                M.report(M.ReportType.click2CloseAd, {
                    count: 1
                }),
    ...
    !function() {
        ...
        [
            ...
            function r(o) {
                switch (o.code) {
                case 200:
                    t.newLoginPage(o.redirect_uri).then(function(t) {
                ...
                case 201:
                    ...
                    t.checkLogin(e.uuid).then(r, function(t) {
                ...
                e.code = o.code,
                e.userAvatar = o.userAvatar,
                a.log("get code", o.code)
            }
            function c() {
                t.getUUID().then(function(i) {
                    ...
                    ,
                    t.checkLogin(i, 1).then(r, function(t) {
            ...
            function s() {
                t.checkLogin(e.uuid, 1).then(r, function(t) {
                    !t && window.checkLoginPromise && (e.isBrokenNetwork = !0)
                })
            }
            ...
            !window.MMCgi.isLogin) {
                ...
                e.isRotateLoading = !1,
                e.isBrokenNetwork = !1,
                e.isClientVersion = o.isClientVersion;
                var l;
                    ...
                    setTimeout(function() {
                        ...
                        if (n.MsgType == f.MSGTYPE_EMOTICON || n.MsgType == f.MSGTYPE_IMAGE || n.MsgType == f.MSGTYPE_VIDEO) {
                            ...
                            if (n.ImgHeight)
                                ...
                                t.$destroy(),
                                a.remove();
                            else if (s > 40 || 1 == c[0].complete && (c[0].naturalWidth,
                            !(0 === c[0].naturalWidth)) && s > 0)
                                i(a.height()),
                                t.$destroy(),
                                a.remove();
                            else {
                    ...
                    try {
                        K = e.create({
                            ...
                            !l.getSendFileUsername())
                                ...
                                alert(_("599d8df")),
                                !1;
                            if (/untitled\d+.png/i.test(e.name) || q)
                                k(e, ee),
            ...
            function u(e) {
                ...
                for (var n = [e.target], i = e.path || e.originalEvent.path || a(e.target), o = 0, r = i.length; o < r; o++) {
                    ...
                    if (c) {
                        ...
                        l.width())
                          , f = l.height();
                        d - e.pageX < 400 && (t.contextStyle.right = d - e.pageX,
                        t.contextStyle.left = "auto"),
                        f - e.pageY < 400 && (t.contextStyle.bottom = f - e.pageY,
                        t.contextStyle.top = "auto");
                        break
                    }
                }
            }
            ...
            var _chatList = [], _chatListInfos = [], _chatMessages = window._chatContent = {}, _currentUserName = "", _addedMsgIdsMap = {}, _msgMap = {}, _sendFileUserName, _currentUnreadMap = {}, _rChatList = [], _SChatList = [], service = {
                ...
                postAppMessage: function(e) {
                    ...
                    e.AppMsgType == confFactory.APPMSGTYPE_ATTACH) {
                        ...
                        t.Content = "<appmsg appid='" + a + "' sdkver=''><title>" + e.FileName + "</title><des></des><action></action><type>" + confFactory.APPMSGTYPE_ATTACH + "</type><content></content><url></url><lowurl></lowurl><appattach><totallen>" + e.FileSize + "</totallen><attachid>" + e.MediaId + "</attachid><fileext>" + (e.MMFileExt || e.MMAppMsgFileExt) + "</fileext></appattach><extinfo></extinfo></appmsg>"
                    } else
                ...
                _recalledMsgProcess: function(e) {
                    ...
                    o = utilFactory.xml2json(i.replace(/<br\/>/g, "")).revokemsg,
                    0 == o.msgid) {
    ...
    !function() {
        ...
        angular.module("Services").factory("confFactory", ["$q", function(e) {
            ...
            var c = {
                ...
                API_jsLogin: "https://" + a + "/jslogin?appid=wx782c26e4c19acffb&redirect_uri=" + encodeURIComponent(location.protocol + "//" + location.host + "/cgi-bin/mmwebwx-bin/webwxnewloginpage" + (r ? "?mod=desktop" : "")) + "&fun=new&lang=" + o,
        ...
        angular.module("Services").factory("loginFactory", ["$http", "$q", "$timeout", "accountFactory", "confFactory", "utilFactory", "mmHttp", "reportService", function(e, t, a, n, i, o, r, c) {
            var s = {
                ...
                associationLogin: function(e) {
                    ...
                    return i.isClientVersion && (n += "&mod=desktop"),
                    $.ajax({
                        url: n,
                        dataType: "json"
                    }).done(function(e) {
...
, function(e, exports) {
    !function(e) {
        "use strict";
        angular.module("Services").factory("titleRemind", ["$window", "confFactory", function(e, t) {
            function a(e, t) {
                function a() {
                    i[n] ? e() : t()
                }
                ...
                o = "visibilitychange") : "undefined" != typeof i.mozHidden ? (n = "mozHidden",
                o = "mozvisibilitychange") : "undefined" != typeof i.msHidden ? (n = "msHidden",
                o = "msvisibilitychange") : "undefined" != typeof i.webkitHidden && (n = "webkitHidden",
                o = "webkitvisibilitychange"),
                "undefined" == typeof i.addEventListener || "undefined" == typeof n ? ($(window).focus(function() {
                    t()
                }),
...
, function(e, exports, t) {
    var a, n, i;
    !function(o, r) {
        "undefined" != typeof e && e.exports ? e.exports = r(t(266)) : (n = [t(266)],
        a = r,
